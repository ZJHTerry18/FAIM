...
class VCClothes(object):
    ...
    def __init__(self, root='data', mode='all', train_with_mask=True, test_with_mask=False, **kwargs):
    ...
    def _process_dir_test(self):
        ...
        for img_path in query_img_paths:
            ...
            if self.test_with_mask:
                ...
                query_dataset.append((img_path, pid, camid, clothes_id, mask))
            else:
        ...
        for img_path in gallery_img_paths:
            ...
            if self.test_with_mask:
                ...
                gallery_dataset.append((img_path, pid, camid, clothes_id, mask))
            else:
