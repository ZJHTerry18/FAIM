...
class VisionTransformer(nn.Module):
    ...
    def __init__(
        ...
        torch._assert(image_height % patch_size == 0 and image_width % patch_size == 0, "Input shape indivisible by patch size!")
        ...
        seq_length = (self.image_size[0] // patch_size) * (self.image_size[1]) // patch_size
...
def _vision_transformer(
    ...
    **kwargs: Any,
    ...
    image_height = kwargs["image_size"][0]
    image_width = kwargs["image_size"][1]
